    ...
    <div class="container section">
		<div class="row">
			<div class="col-md-4 card shadow-lg m-auto">
				<h2 class="mt-3 section-head"><span style="">Forget</span> Password</h2>
				<form method="post" action="forgetdb.php" onsubmit="return Validation()">
                <div class="form-group  mt-2">
					<label><span>User</span>name</label>
					<input type="email" class="form-control" name="username" placeholder="@gmail.com." id="username">
          <label for=""><span id="usererror"></span></label>
				</div>
