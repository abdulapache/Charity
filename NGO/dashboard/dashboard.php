        ...
        <div class="col py-3 content section shadow-lg mt-3">
          ...
          <div class="row">
            <div class="col-md-4 col-12 p-3">
              <div class="card bg-success text-white" style="width: 18rem; shadow">
                <div class="card-body">
          ...
          <div class="col-md-4 col-12 p-3">
              <div class="card bg-primary text-white" style="width: 18rem; shadow">
                <div class="card-body">
                  <h5 class="card-title text-center">DONOR</h5>

<?php

$donor=$con->query("SELECT * FROM donors");
$donor_all=mysqli_num_rows($donor);

?>

                  <p class="card-text text-center" style="font-size:50px;color:red;font-weight:700;">
          ...
          <div class="col-md-4 col-12 p-3">
              <div class="card bg-secondary text-white" style="width: 18rem; shadow">
                <div class="card-body">
        ...
        <div class="row mt-3">
            <div class="col-md-4 col-12 p-3">
              <a href="#" type="button" data-bs-toggle="modal" data-bs-target="#city">
              <div class="card bg-warning text-white" style="width: 18rem; shadow">
                <div class="card-body">
          ...
          <div class="col-md-4 col-12 p-3">
              <div class="card bg-info text-white" style="width: 18rem; shadow">
                <div class="card-body">
          ...
          <div class="col-md-4 col-12 p-3">
              <div class="card bg-danger text-white" style="width: 18rem; shadow">
                <div class="card-body">
                  <h5 class="card-title text-center">Pending Request</h5>
                  <?php

$pandding=$con->query("SELECT * FROM request");
$pandding_all=mysqli_num_rows($pandding);

?>
                  <p class="card-text text-center" style="font-size:50px;color:red;font-weight:700;"><?php echo $pandding_all?></p>
                  <p class="card-text">All needy people who get the help of this application.</p>
                </div>
              </div>
          </div>
